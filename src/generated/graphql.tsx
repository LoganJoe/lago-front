...
export type ChargeInput = {
  ...
  minAmountCents?: InputMaybe<Scalars['BigInt']>;
  payInAdvance?: InputMaybe<Scalars['Boolean']>;
...
/** Autogenerated input type of CreateAppliedTax */
export type CreateAppliedTaxInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  customerId: Scalars['ID'];
  taxId: Scalars['ID'];
...
export type CustomerMetadata = {
  ...
  createdAt: Scalars['ISO8601DateTime'];
  displayInInvoice: Scalars['Boolean'];
  id: Scalars['ID'];
  key: Scalars['String'];
  updatedAt: Scalars['ISO8601DateTime'];
...
/** Autogenerated input type of DestroyAppliedTax */
export type DestroyAppliedTaxInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  id: Scalars['ID'];
};
...
export type FeeInput = {
  ...
  description?: InputMaybe<Scalars['String']>;
  name?: InputMaybe<Scalars['String']>;
  unitAmountCents?: InputMaybe<Scalars['BigInt']>;
...
export type GraduatedRange = {
  ...
  fromValue: Scalars['BigInt'];
  perUnitAmount: Scalars['String'];
  toValue?: Maybe<Scalars['BigInt']>;
};
...
export type Invoice = {
  ...
  feesAmountCents: Scalars['BigInt'];
  fileUrl?: Maybe<Scalars['String']>;
  id: Scalars['ID'];
  ...
  prepaidCreditAmountCents: Scalars['BigInt'];
...
export type Mutation = {
  ...
  createAppliedTax?: Maybe<AppliedTax>;
  ...
  destroyAppliedTax?: Maybe<AppliedTax>;
...
export type MutationCreateAppliedTaxArgs = {
  input: CreateAppliedTaxInput;
};
...
export type MutationDestroyAppliedTaxArgs = {
  input: DestroyAppliedTaxInput;
};
...
export type OrganizationTaxesArgs = {
  appliedToOrganization?: InputMaybe<Scalars['Boolean']>;
...
export type Properties = {
  ...
  freeUnits?: Maybe<Scalars['BigInt']>;
  freeUnitsPerEvents?: Maybe<Scalars['BigInt']>;
  freeUnitsPerTotalAggregation?: Maybe<Scalars['String']>;
  graduatedRanges?: Maybe<Array<GraduatedRange>>;
  packageSize?: Maybe<Scalars['BigInt']>;
...
export type PropertiesInput = {
  ...
  freeUnits?: InputMaybe<Scalars['BigInt']>;
  freeUnitsPerEvents?: InputMaybe<Scalars['BigInt']>;
  freeUnitsPerTotalAggregation?: InputMaybe<Scalars['String']>;
  graduatedRanges?: InputMaybe<Array<GraduatedRangeInput>>;
  packageSize?: InputMaybe<Scalars['BigInt']>;
...
export type Tax = {
  __typename?: 'Tax';
  appliedToOrganization: Scalars['Boolean'];
  code: Scalars['String'];
  createdAt: Scalars['ISO8601DateTime'];
...
export type CreditNoteFormFragment = { __typename?: 'Invoice', id: string, couponsAmountCents: any, paymentStatus: InvoicePaymentStatusTypeEnum, creditableAmountCents: any, refundableAmountCents: any, feesAmountCents: any, vatRate: number, currency?: CurrencyEnum | null, versionNumber: number };
...
export type CustomerMainInfosFragment = { __typename?: 'Customer', id: string, name?: string | null, externalId: string, legalName?: string | null, legalNumber?: string | null, phone?: string | null, email?: string | null, currency?: CurrencyEnum | null, addressLine1?: string | null, addressLine2?: string | null, state?: string | null, country?: CountryCode | null, city?: string | null, url?: string | null, zipcode?: string | null, paymentProvider?: ProviderTypeEnum | null, timezone?: TimezoneEnum | null, providerCustomer?: { __typename?: 'ProviderCustomer', id: string, providerCustomerId?: string | null } | null, metadata?: Array<{ __typename?: 'CustomerMetadata', id: string, key: string, value: string }> | null };
...
export type InvoiceForCreditNotesTableFragment = { __typename?: 'Invoice', id: string, customer: { __typename?: 'Customer', id: string }, creditNotes?: Array<{ __typename?: 'CreditNote', id: string, couponsAdjustmentAmountCents: any, creditAmountCurrency: CurrencyEnum, number: string, subTotalVatExcludedAmountCents: any, subTotalVatExcludedAmountCurrency: CurrencyEnum, totalAmountCents: any, vatAmountCents: any, vatAmountCurrency: CurrencyEnum, currency: CurrencyEnum, items: Array<{ __typename?: 'CreditNoteItem', amountCents: any, amountCurrency: CurrencyEnum, fee: { __typename?: 'Fee', id: string, amountCents: any, amountCurrency: CurrencyEnum, eventsCount?: any | null, units: number, feeType: FeeTypesEnum, itemName: string, trueUpParentFee?: { __typename?: 'Fee', id: string } | null, charge?: { __typename?: 'Charge', id: string, billableMetric: { __typename?: 'BillableMetric', id: string, name: string, aggregationType: AggregationTypeEnum } } | null, subscription?: { __typename?: 'Subscription', id: string, name?: string | null, plan: { __typename?: 'Plan', id: string, name: string } } | null, group?: { __typename?: 'Group', id: string, key?: string | null, value: string } | null } }> }> | null };
...
export type AddCustomerDrawerFragment = { __typename?: 'Customer', id: string, addressLine1?: string | null, addressLine2?: string | null, applicableTimezone: TimezoneEnum, canEditAttributes: boolean, city?: string | null, country?: CountryCode | null, currency?: CurrencyEnum | null, email?: string | null, externalId: string, legalName?: string | null, legalNumber?: string | null, name?: string | null, paymentProvider?: ProviderTypeEnum | null, phone?: string | null, state?: string | null, timezone?: TimezoneEnum | null, zipcode?: string | null, url?: string | null, providerCustomer?: { __typename?: 'ProviderCustomer', id: string, providerCustomerId?: string | null, syncWithProvider?: boolean | null } | null, metadata?: Array<{ __typename?: 'CustomerMetadata', id: string, key: string, value: string, displayInInvoice: boolean }> | null };
...
export type TaxFormFragment = { __typename?: 'Tax', id: string, code: string, description?: string | null, name: string, rate: number };
...
export type GetSingleTaxQuery = { __typename?: 'Query', tax?: { __typename?: 'Tax', id: string, code: string, description?: string | null, name: string, rate: number } | null };
...
export type CreateTaxMutation = { __typename?: 'Mutation', createTax?: { __typename?: 'Tax', id: string, code: string, description?: string | null, name: string, rate: number } | null };
...
export type UpdateTaxMutation = { __typename?: 'Mutation', updateTax?: { __typename?: 'Tax', id: string, code: string, description?: string | null, name: string, rate: number } | null };
...
export type GetInfosForCreateInvoiceQuery = { __typename?: 'Query', customer?: { __typename?: 'Customer', id: string, addressLine1?: string | null, addressLine2?: string | null, city?: string | null, country?: CountryCode | null, currency?: CurrencyEnum | null, email?: string | null, name?: string | null, state?: string | null, vatRate?: number | null, zipcode?: string | null } | null, organization?: { __typename?: 'Organization', id: string, addressLine1?: string | null, addressLine2?: string | null, city?: string | null, country?: CountryCode | null, email?: string | null, name: string, logoUrl?: string | null, state?: string | null, zipcode?: string | null, billingConfiguration?: { __typename?: 'OrganizationBillingConfiguration', id: string, vatRate: number } | null } | null };
...
export type GetCreditNoteQuery = { __typename?: 'Query', creditNote?: { __typename?: 'CreditNote', id: string, balanceAmountCents: any, canBeVoided: boolean, couponsAdjustmentAmountCents: any, createdAt: any, creditAmountCents: any, creditAmountCurrency: CurrencyEnum, creditStatus?: CreditNoteCreditStatusEnum | null, currency: CurrencyEnum, number: string, refundAmountCents: any, refundedAt?: any | null, refundStatus?: CreditNoteRefundStatusEnum | null, subTotalVatExcludedAmountCents: any, subTotalVatExcludedAmountCurrency: CurrencyEnum, totalAmountCents: any, totalAmountCurrency: CurrencyEnum, vatAmountCents: any, vatAmountCurrency: CurrencyEnum, customer: { __typename?: 'Customer', id: string, name?: string | null, deletedAt?: any | null, applicableTimezone: TimezoneEnum }, invoice?: { __typename?: 'Invoice', id: string, number: string } | null, items: Array<{ __typename?: 'CreditNoteItem', amountCents: any, amountCurrency: CurrencyEnum, fee: { __typename?: 'Fee', id: string, amountCents: any, amountCurrency: CurrencyEnum, eventsCount?: any | null, units: number, feeType: FeeTypesEnum, itemName: string, trueUpParentFee?: { __typename?: 'Fee', id: string } | null, charge?: { __typename?: 'Charge', id: string, billableMetric: { __typename?: 'BillableMetric', id: string, name: string, aggregationType: AggregationTypeEnum } } | null, subscription?: { __typename?: 'Subscription', id: string, name?: string | null, plan: { __typename?: 'Plan', id: string, name: string } } | null, group?: { __typename?: 'Group', id: string, key?: string | null, value: string } | null } }> } | null };

export type CustomerDetailsFragment = { __typename?: 'Customer', id: string, name?: string | null, externalId: string, hasActiveWallet: boolean, currency?: CurrencyEnum | null, hasCreditNotes: boolean, creditNotesCreditsAvailableCount: number, creditNotesBalanceAmountCents: any, applicableTimezone: TimezoneEnum, activeSubscriptionCount: number, addressLine1?: string | null, addressLine2?: string | null, canEditAttributes: boolean, city?: string | null, country?: CountryCode | null, email?: string | null, legalName?: string | null, legalNumber?: string | null, paymentProvider?: ProviderTypeEnum | null, phone?: string | null, state?: string | null, timezone?: TimezoneEnum | null, zipcode?: string | null, url?: string | null, providerCustomer?: { __typename?: 'ProviderCustomer', id: string, providerCustomerId?: string | null, syncWithProvider?: boolean | null } | null, metadata?: Array<{ __typename?: 'CustomerMetadata', id: string, key: string, value: string, displayInInvoice: boolean }> | null };
...
export type GetWebhookOrganizationQueryVariables = Exact<{ [key: string]: never; }>;


export type GetWebhookOrganizationQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', id: string, webhookUrl?: string | null } | null };

export type WebhookLogFragment = { __typename?: 'Webhook', id: string, createdAt: any, status: WebhookStatusEnum, updatedAt: any, webhookType: string, payload?: string | null, response?: string | null, httpStatus?: number | null, endpoint: string, retries: number };
...
export const GetWebhookOrganizationDocument = gql`
...
/**
 * __useGetWebhookOrganizationQuery__
 *
 * To run a query within a React component, call `useGetWebhookOrganizationQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetWebhookOrganizationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetWebhookOrganizationQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetWebhookOrganizationQuery(baseOptions?: Apollo.QueryHookOptions<GetWebhookOrganizationQuery, GetWebhookOrganizationQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWebhookOrganizationQuery, GetWebhookOrganizationQueryVariables>(GetWebhookOrganizationDocument, options);
      }
export function useGetWebhookOrganizationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWebhookOrganizationQuery, GetWebhookOrganizationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWebhookOrganizationQuery, GetWebhookOrganizationQueryVariables>(GetWebhookOrganizationDocument, options);
        }
export type GetWebhookOrganizationQueryHookResult = ReturnType<typeof useGetWebhookOrganizationQuery>;
export type GetWebhookOrganizationLazyQueryHookResult = ReturnType<typeof useGetWebhookOrganizationLazyQuery>;
export type GetWebhookOrganizationQueryResult = Apollo.QueryResult<GetWebhookOrganizationQuery, GetWebhookOrganizationQueryVariables>;
